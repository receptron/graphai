...
class GraphAI {
            ...
            if (isStaticNode) {
                ...
                if (fork) {
                    ...
                    nodeId2forkedNodeIds[nodeId] = new Array(fork).fill(undefined).map((_, i) => {
                        ...
                        _nodes[forkedNodeId] = new node_1.ComputedNode(forkedNodeId, i, nodeData, this);
                    ...
                    _nodes[nodeId] = new node_1.ComputedNode(nodeId, undefined, nodeData, this);
                }
            }
            return _nodes;
        }, {});
    ...
    constructor(data, callbackDictonary, taskManager = undefined) {
        ...
        this.taskManager = taskManager ?? new task_1.TaskManager(data.concurrency ?? defaultConcurrency);
        this.loop = data.loop;
