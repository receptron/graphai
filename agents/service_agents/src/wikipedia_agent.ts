...
export const wikipediaAgent: AgentFunction<{ lang?: string; summary?: boolean }, Record<string, any> | undefined, { query: string }> = async ({ namedInputs, params }) => {
