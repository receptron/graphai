...
export declare const flatDataSourceNodeIds: (sources: (DataSource | DataSources | NestedDataSource)[]) => string[];
export declare const flatDataSource: (sources: (DataSource | DataSources | NestedDataSource)[]) => DataSource[];
