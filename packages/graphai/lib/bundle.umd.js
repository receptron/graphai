(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.graphai = {}));
    ...
    class TransactionLog {
        constructor(nodeId) {
            this.nodeId = nodeId;
            this.state = exports.NodeState.Waiting;
        }
    ...
    class ComputedNode extends Node {
        ...
        isReadyNode() {
            if (this.state !== exports.NodeState.Waiting || this.pendings.size !== 0) {
                return false;
            }
            if ((this.ifSource && !isLogicallyTrue(this.graph.resultOf(this.ifSource))) ||
                ...
                this.state = exports.NodeState.Skipped;
        ...
        beforeAddTask() {
            this.state = exports.NodeState.Queued;
        ...
        executeTimeout(transactionId) {
            if (this.state === exports.NodeState.Executing && this.isCurrentTransaction(transactionId)) {
                console.warn(`-- timeout ${this.timeout} with ${this.nodeId}`);
                this.retry(exports.NodeState.TimedOut, Error("Timeout"));
            }
        }
        ...
        async execute() {
            ...
            try {
                ...
                this.state = exports.NodeState.Completed;
        ...
        prepareExecute(transactionId, inputs) {
            this.state = exports.NodeState.Executing;
        ...
        errorProcess(error, transactionId, namedInputs) {
            ...
            if (error instanceof Error) {
                this.retry(exports.NodeState.Failed, error);
            }
            else {
                console.error(`-- NodeId: ${this.nodeId}: Unknown error was caught`);
                this.retry(exports.NodeState.Failed, Error("Unknown"));
            }
        }
        getParams() {
    ...
    class StaticNode extends Node {
        ...
        injectValue(value, injectFrom) {
            this.state = exports.NodeState.Injected;
            this.result = value;
    ...
    exports.defaultAgentInfo = defaultAgentInfo;
    exports.defaultConcurrency = defaultConcurrency;
    exports.defaultTestContext = defaultTestContext;
    exports.graphDataLatestVersion = graphDataLatestVersion;
