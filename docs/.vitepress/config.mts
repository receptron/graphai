...
import { generateAgentsSidebar, generateApiDocSidebar, generateExternalAgentsSidebar } from "./helpers/generateSidebar";
...
export default async () => {
  ...
  const externalAgentsSidebar = await generateExternalAgentsSidebar();
